...
% (4) Estimation of Smooth-transitioning VAR, according to Eq.(6)
...
%%
%Specification 2 (replace unemployment with job finding probability, baseline)
...
%shockpos = 5; %CAN uncertainty shock = 5 (Baseline ordering)
...
writetable(tab,'./Results/InfC_baseline_2.xlsx') 
...
save(strcat(folder, '/out_2_us.mat'), 'STVAR', 'VAR','printvars','folder') %US Uncertainty shock
%save(strcat(folder, '/out_2_can.mat'), 'STVAR', 'VAR','printvars','folder') %CAN Uncertainty shock
