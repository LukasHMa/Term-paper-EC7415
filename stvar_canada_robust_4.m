...
% (4) Estimation of Smooth-transitioning VAR, using a different
% transitional variable, namely the four-quarter backward moving average of
...
save(strcat(folder, '/out_5_can.mat'),  'STVAR', 'VAR','printvars','folder') %CAN Uncertainty shock